   ...
   <div class="card col-md-6">
    ...
    <?= csrf_field()?>
        ...
        <div class="input-style-1">
               ...
               <textarea name="alamat_lokasi" placeholder="Alamat lokasi" class="form-control <?= ($validation->hasError('alamat_lokasi'))? 'is-invalid' : '' ?>" ><?= $lokasi_presensi['alamat_lokasi'] ?></textarea>
