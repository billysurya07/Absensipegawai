   ...
   <div class="card col-md-6">
    ...
    <?= csrf_field()?>
        ...
        <div class="input-style-1">
               ...
               <textarea name="deskripsi"  placeholder="Deskripsi" class="form-control <?= ($validation->hasError('deskripsi'))? 'is-invalid' : '' ?>" ><?= set_value('deskripsi') ?><?= $ketidakhadiran['deskripsi'] ?></textarea>
